...
import styles from './LoteConciliado.module.css'; 
import Button from '../../../layout/components/Button';
import Input from '../../../layout/components/Input';
import Pagination from "../../../layout/components/Pagination";

import { BASE_URL, URL_TITULOS_CONCILIADOS } from "../../../../utils/requests";
import Loading from "../../../layout/components/Loading";
import ListaLoteConciliado from "./ListaLoteConciliado";
...
function LoteConciliado() {
  ...
  const consultarDados = () => {
    axios
        .get(`${BASE_URL}${URL_TITULOS_CONCILIADOS}?size=25&page=${pageNumber}&dataInicial=${consulta.dataInicial}&dataFinal=${consulta.dataFinal}`)
        .then((response) => {
  ...
  return (
    <div className={styles.titulos_container}>
        ...
        <div className={styles.titulos_container_cabecalho}>
          <div className={styles.titulos_titulo}>Títulos Conciliados para Equals</div>
        </div>
